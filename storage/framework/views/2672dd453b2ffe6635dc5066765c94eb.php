 <header class="fixed top-0 left-0 right-0 z-50 bg-white border-b border-slate-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                <a href="<?php echo e(route('index')); ?>" class="flex items-center gap-3">
    ...
    </header><?php /**PATH C:\Users\HP\Desktop\FirstApp\resources\views/layouts/header.blade.php ENDPATH**/ ?>